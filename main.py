...
def main():
    ...
    data_composer.record_file_content_into_basic_result_file(file_with_min_col, columns_of_result_file)
    print(data_composer.record_leftovers_files_into_result(columns_of_result_file))
